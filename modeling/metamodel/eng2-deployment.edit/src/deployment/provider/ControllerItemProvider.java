...
/**
 * This is the item provider adapter for a {@link deployment.Controller} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControllerItemProvider extends JavaClassItemProvider {
  /**
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Controller_uri_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Controller_uri_feature", "_UI_Controller_type"),
         DeploymentPackage.Literals.CONTROLLER__URI,
         true,
         false,
         false,
  ...
  public String getText(Object object) {
    String label = ((Controller)object).getClassName();
