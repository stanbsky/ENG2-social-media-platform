 ...
 *   <li>{@link deployment.impl.ProducerImpl#getMethod <em>Method</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProducerImpl extends MinimalEObjectImpl.Container implements Producer {
	 ...
	 * @ordered
	 */
	protected EList<ProducerMethod> method;
	 ...
	 * @generated
	 */
	public EList<ProducerMethod> getMethod() {
		if (method == null) {
			method = new EObjectContainmentEList<ProducerMethod>(ProducerMethod.class, this, DeploymentPackage.PRODUCER__METHOD);
		}
		return method;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DeploymentPackage.PRODUCER__METHOD:
				getMethod().clear();
				getMethod().addAll((Collection<? extends ProducerMethod>)newValue);
				return;
		}
