...
public interface DeploymentPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "https://Y3884010/v2";
	 ...
	 * @ordered
	 */
	int CLI_TOOL__COMMANDS = JAVA_CLASS_FEATURE_COUNT + 0;
	...
	/**
	 * The feature id for the '<em><b>Controller Method</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int COMMAND__CONTROLLER_METHOD = JAVA_CLASS_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int COMMAND_FEATURE_COUNT = JAVA_CLASS_FEATURE_COUNT + 3;
	...
	/**
	 * The meta object id for the '{@link deployment.impl.ProducerMethodImpl <em>Producer Method</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see deployment.impl.ProducerMethodImpl
	 * @see deployment.impl.DeploymentPackageImpl#getProducerMethod()
	 * @generated
	 */
	int PRODUCER_METHOD = 11;
	 ...
	 * @ordered
	 */
	int PRODUCER_METHOD__TOPICS = 1;

	/**
	 * The number of structural features of the '<em>Producer Method</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PRODUCER_METHOD_FEATURE_COUNT = 2;

	/**
	 * The number of operations of the '<em>Producer Method</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PRODUCER_METHOD_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link deployment.CliTool#getCommands <em>Commands</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Commands</em>'.
	 * @see deployment.CliTool#getCommands()
	 * @see #getCliTool()
	 * @generated
	 */
	EReference getCliTool_Commands();
	...
	/**
	 * Returns the meta object for the reference '{@link deployment.Command#getControllerMethod <em>Controller Method</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Controller Method</em>'.
	 * @see deployment.Command#getControllerMethod()
	 * @see #getCommand()
	 * @generated
	 */
	EReference getCommand_ControllerMethod();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link deployment.Producer#getMethod <em>Method</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Method</em>'.
	 * @see deployment.Producer#getMethod()
	 * @see #getProducer()
	 * @generated
	 */
	EReference getProducer_Method();

	/**
	 * Returns the meta object for class '{@link deployment.ProducerMethod <em>Producer Method</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Producer Method</em>'.
	 * @see deployment.ProducerMethod
	 * @generated
	 */
	EClass getProducerMethod();

	/**
	 * Returns the meta object for the attribute '{@link deployment.ProducerMethod#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see deployment.ProducerMethod#getName()
	 * @see #getProducerMethod()
	 * @generated
	 */
	EAttribute getProducerMethod_Name();

	/**
	 * Returns the meta object for the reference list '{@link deployment.ProducerMethod#getTopics <em>Topics</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Topics</em>'.
	 * @see deployment.ProducerMethod#getTopics()
	 * @see #getProducerMethod()
	 * @generated
	 */
	EReference getProducerMethod_Topics();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference CLI_TOOL__COMMANDS = eINSTANCE.getCliTool_Commands();
		...
		/**
		 * The meta object literal for the '<em><b>Controller Method</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference COMMAND__CONTROLLER_METHOD = eINSTANCE.getCommand_ControllerMethod();
		 ...
		 * @generated
		 */
		EReference PRODUCER__METHOD = eINSTANCE.getProducer_Method();

		/**
		 * The meta object literal for the '{@link deployment.impl.ProducerMethodImpl <em>Producer Method</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see deployment.impl.ProducerMethodImpl
		 * @see deployment.impl.DeploymentPackageImpl#getProducerMethod()
		 * @generated
		 */
		EClass PRODUCER_METHOD = eINSTANCE.getProducerMethod();
		 ...
		 * @generated
		 */
		EAttribute PRODUCER_METHOD__NAME = eINSTANCE.getProducerMethod_Name();
		 ...
		 * @generated
		 */
		EReference PRODUCER_METHOD__TOPICS = eINSTANCE.getProducerMethod_Topics();
