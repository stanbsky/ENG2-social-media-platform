...
/**
 * This is the item provider adapter for a {@link deployment.Microservice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MicroserviceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DeploymentPackage.Literals.MICROSERVICE__PORT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeploymentPackage.Literals.MICROSERVICE__CONTROLLERS);
			childrenFeatures.add(DeploymentPackage.Literals.MICROSERVICE__PRODUCERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DeploymentPackage.Literals.MICROSERVICE__CONTROLLERS,
				 DeploymentFactory.eINSTANCE.createController()));

		newChildDescriptors.add
			(createChildParameter
				(DeploymentPackage.Literals.MICROSERVICE__PRODUCERS,
				 DeploymentFactory.eINSTANCE.createProducer()));
	}
