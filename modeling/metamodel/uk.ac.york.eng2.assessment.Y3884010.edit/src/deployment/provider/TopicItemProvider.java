...
/**
 * This is the item provider adapter for a {@link deployment.Topic} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DeploymentPackage.Literals.TOPIC__NAME,
				 true,
				 false,
				 false,
	...
	protected void addKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Topic_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Topic_key_feature", "_UI_Topic_type"),
				 DeploymentPackage.Literals.TOPIC__KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Topic_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Topic_value_feature", "_UI_Topic_type"),
				 DeploymentPackage.Literals.TOPIC__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
